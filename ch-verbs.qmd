...
:::: ex
::: gl
| - Lango (done)ganis nide.
| lan-go (done)gani-s ni-de
| PST:PASS-1sg save-PASS.PRT  2s-ABL:SG
| 'I was saved by you.'
:::
::::
...
::: gl
| - Luesah omis jekines.
| luesah omi-s jeki-nes
| PST.3pl.N be.EXPL-PST.PRTC monkey-PRED:PL
...
:::: ex
::: gl
| - Dlantigo an fladriba.
| dlanti-go an fladri-ba
